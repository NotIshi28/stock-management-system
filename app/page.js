...
export default function Home() {
  // Sample data for existing stock
  const [stockItems, setStockItems] = useState([
    { id: 1, name: 'Product A', quantity: 10, price: 9.99 },
    { id: 2, name: 'Product B', quantity: 5, price: 19.99 },
    { id: 3, name: 'Product C', quantity: 15, price: 14.99 },
  ]);
  ...
  // Function to handle search dropdown change
